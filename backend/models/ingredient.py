...
from utils.helpers import serialize_document, get_days_until_expiry

class Ingredient:
    def __init__(self, name, best_used_days, price_per_unit, unit, current_stock=0, last_restock_date=None):
        self.name = name
